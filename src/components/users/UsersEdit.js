    ...
    const save = async (event) => {
        ...
        if(errors.length > 0){
            ...
            const requestOptions = {
                ...
                body: JSON.stringify({ "operatorId": config.operatorId, "name": userName.value,"MSU": nickname.value,"price": password.value,"stock": level.value})
              }
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="level" className="control-label">Nivel del Usuario</label>
