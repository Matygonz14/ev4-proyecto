                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="MSU" className="control-label">Apodo del Usuario</label>
                                        <input type="text" name="nickname" id="nickname" className="form-control" required />
                                    </div>
                                </div>
                                <div className="col-4">
                                    <div className="form-group">
                                        <label htmlFor="MSU" className="control-label">Contraseña</label>
                                        <input type="text" name="password" id="password" className="form-control" required />
                                    </div>
                                </div>
                                <div className="col-6">
                                    <div className="form-group">
                                        <label htmlFor="price" className="control-label">Nivel del Usuario</label>
