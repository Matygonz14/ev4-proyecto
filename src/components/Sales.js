                            ...
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        ...
                                        <select type="number" className="form-control" name="MSU" id="MSU">
                                            <option value="0">--Debajo Sale el stock del producto seleccionado..</option>
                                            {productList.map(product => (
                                            <option key={product.id} value={product.id}>
                                                {product.name} = {product.MSU}
                                            </option>
                                            ))}
                                        </select>
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        ...
                                        <select className="form-control" name="stock" id="stock"  >
                                            <option value="0">--Debajo Sale el stock del producto seleccionado..</option>
                                            {productList.map(product => (
                                            <option key={product.id} value={product.id}>
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        ...
                                        <select className="form-control" type="number" name="unitary" id="unitary">
                                            <option value="0">--Debajo Sale el precio unitario..</option>
                                            {productList.map(product => (
                                            <option key={product.id} value={product.id}>
                                                {product.name} = {product.price} CLP
                                            </option>
                                            ))}
                                        </select>
                                    </div>
