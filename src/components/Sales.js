                            ...
                            <div className="row">
                                ...
                                <div className="col-4">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" name="msv" id="msv" readOnly={true} value={this.state.product.MSU} />
                                    </div>
                                </div>
                                <div className="col-4">
                                    <div className="form-group">
                                        <label className="label-control" >Stock</label>
                                        <input type="text" className="form-control" name="stock" id="stock" readonly={true} value={this.state.product.stock} / >
                                    </div>
                                </div>
                                <div className="col-4">
                                    <div className="form-group">
